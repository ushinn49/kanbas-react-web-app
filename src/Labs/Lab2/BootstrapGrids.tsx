...
export default function BootstrapGrids() {
  return (
    <Container>
      ...
      <hr />
      {/* Content from Section 2.3.3 */}
      <div id="wd-bs-grid-system">
        <h3>Grid system</h3> {/* "Grid system" heading from source 741 */}
        <Row> {/* First Row example from source 741 */}
        ...
        <Row> {/* Second Row example with xs attributes from source 741 */}
        ...
        <Row> {/* Third Row example with three columns from source 741 */}
